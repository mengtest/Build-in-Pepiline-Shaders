Shader "Unlit/cubemap_01"
{
    Properties
    {
        ...
        _ReflectionAmount("ReflectionAmount",Range(0,1)) = 0.5
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
               ...
               //反射
               o.worldRefl = reflect(-normalize(o.worldViewDir),worldNormal);
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed3 reflection = texCUBE(_CubeMap,i.worldRefl).rgb * _ReflectionColor;

                fixed3 diffuse = lerp(diffColor,reflection,_ReflectionAmount);
